...
def add_user(users, username, password):
    ...
    # Задача: если пользователь уже существует, то вернуть сообщение - "Пользователь с таким логином уже существует."
    # Задача: если пользователя в словаре нет, то добавить в словарь новую запись, ключ - имя пользователя, значение - пароль.
